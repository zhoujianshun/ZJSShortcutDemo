...
- (id)handlerForIntent:(INIntent *)intent {
    ...
    if ([intent isKindOfClass:[DepositeDefinitionIntent class]]) {
        return [[ZJSDepositeDefinitionIntentHandler alloc] init];
    }else if([intent isKindOfClass:[WithdrawDefinitionIntent class]]){
        return [[ZJSWithdrawDefinitionIntentHandler alloc] init];
    }
    return self;
}
